...
(err, res) {
//se validador for válido, res=true e executa o saves()
...
fetch('https://b401-back-webitcloud.c9users.io/insCompanies', {
...
let txt = "";
const response = await fetch('https://b401-back-webitcloud.c9users.io/insCompanies');
