...
window.onload = function() {
    //chama a função para atualizar as empresas
           ...
           data.tipo_empresa = document.getElementById("tipo").value;
            data.site = document.getElementById("payable").value;
             data.localizacao= document.getElementById("local").value;
              data.doacao = document.getElementById("doacao").value;
              
        
        console.log(data); //debugging para ver os dados que foram enviados
        //chamada fetch para envio dos dados para o servior via POST
        fetch(' https://b401-back-webitcloud.c9users.io/companies', {
    ...
    const renderCompanies = document.getElementById("result");
    let txt = "";
    const response = await fetch(' https://b401-back-webitcloud.c9users.io/companies');
