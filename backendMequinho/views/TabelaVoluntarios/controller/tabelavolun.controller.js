...
data.password = document.getElementById("local").value;

console.log(data); //debugging para ver os dados que foram enviados
//chamada fetch para envio dos dados para o servior via POST
fetch(' https://b401-back-webitcloud.c9users.io/volunttables', {
...
let txt = "";
const response = await fetch(' https://b401-back-webitcloud.c9users.io/volunttables');
...
txt += "<tr><th>Nome</th><th>Email</th><th>Localidade</th><th>Contacto</th></tr></thead><tbody>";
//percorrer a variável volunteers e por cada volunteer cria a linha da tabela com os dados presentes
for (const volunteer of volunteers) {
txt += "<tr><td style='text-align:right'>" + volunteer.nome + "</td><td>" + volunteer.email + "</td><td>" + volunteer.localidade + "</td><td>" + volunteer.contacto + "</td></tr>";
}
txt += "</tbody></table>";
//envia a tabela construida para a view e mostra no object com ID result 
renderVolunteers.innerHTML = txt;
}
